...
[[ ${MODEL:-local-inference-lab/GLM-5.3-Flash-NVFP4} == local-inference-lab/GLM-5.3-Flash-NVFP4 ]] ||
  fail 'TP3 launcher requires the released GLM-5.3 NVFP4 checkpoint'
[[ ${MODEL_REVISION:-46aaae8a82032f77100f2f03e9cc11b391df3b4d} == 46aaae8a82032f77100f2f03e9cc11b391df3b4d ]] ||
  fail 'TP3 launcher pins the R34 checkpoint revision'
export MODEL=local-inference-lab/GLM-5.3-Flash-NVFP4
export MODEL_REVISION=46aaae8a82032f77100f2f03e9cc11b391df3b4d
